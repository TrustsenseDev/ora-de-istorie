  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-center gap-4 flex-wrap">
          ...
          {[
            ...
            <div key={label} className="flex items-center gap-3">
              <div className="text-center">
                <span className={`font-mono font-bold text-base tabular-nums block leading-none ${
              ...
              {i < 3 && <span className={`font-mono font-bold text-sm mb-2 ${
        ...
        <span className="text-slate-500 text-xs hidden sm:block">· 30 iunie 2026, proba E.c</span>
      </div>
    </motion.div>
  );
}
